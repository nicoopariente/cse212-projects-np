...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The Dequeue method was incorrect as it was taking the index 0 of the list instead of the last position.
    ...
    // Defect(s) Found: Another if statement to handle 0 or lower turns scenarios was needed to make it infinite. 
